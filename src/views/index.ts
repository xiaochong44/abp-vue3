...
> = {
  ...
  management_auditlog: () => import('./management/auditlog/index.vue'),
  management_auth: () => import('./management/auth/index.vue'),
  management_dictionary: () => import('./management/dictionary/index.vue'),
  management_organization: () => import('./management/organization/index.vue'),
  management_role: () => import('./management/role/index.vue'),
  management_route: () => import('./management/route/index.vue'),
  management_securitylog: () => import('./management/securitylog/index.vue'),
