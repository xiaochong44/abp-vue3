...
export const FormBaseItem = defineComponent({
  ...
  setup(props, { slots }) {
    ...
    provide(FormLayoutShallowContext, ref(null) as any)

    return () => {
      const gridStyles: Record<string, any> = {}

      const deepLayout = deepLayoutRef.value
			console.log(deepLayout.feedbackLayout)
      const {
        label,
      ...
      const renderContent = h(
        ...
        },
        {
          default: () => [
            h(
              'div',
              { class: cls(`${prefixCls}-control-content`) },
              {
                default: () => [
                  addonBefore &&
                    h(
                      'div',
                      { class: cls(`${prefixCls}-addon-before`) },
                      {
                    ...
                    },
                    {
                      default: () => [
                        ...
                        feedbackIcon &&
                          h(
                            'div',
                            { class: cls(`${prefixCls}-feedback-icon`) },
                            {
                              default: () => [
                  ...
                  addonAfter &&
                    h(
                      'div',
                      { class: cls(`${prefixCls}-addon-after`) },
                      {
